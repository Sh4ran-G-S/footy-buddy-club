...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Footy Ledger — Track sessions, dues & dependable players" },
      { name: "description", content: "Organize football sessions, split ground costs, and track who's paid — purpose-built for friends who play weekly." },
